...
export default function Navbar() {
  ...
  <Link className="navbar-brand mx-3" to="/">Students_Spot</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <a href='/login'><button type="button" className="btn btn-primary mx-3">Login</button></a>
      <a href='/register'><button type="button" className="btn btn-primary mx-3">Register</button></a>
